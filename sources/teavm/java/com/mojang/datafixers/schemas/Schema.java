...
// PATCHED: Minimal Schema class (jar patched to remove FINAL flag).
...
public class Schema {
    ...
    public com.mojang.datafixers.types.Type<?> getChoiceType(com.mojang.datafixers.DSL.TypeReference type, String name) {
        return null;
    }
    
    public com.mojang.datafixers.types.Type<?> getType(com.mojang.datafixers.DSL.TypeReference type) {
        return null;
    }
}
