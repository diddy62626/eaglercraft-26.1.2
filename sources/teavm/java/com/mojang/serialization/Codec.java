...
public interface Codec<T> {
    ...
    default <S> Codec<S> flatXmap(Function<T, DataResult<S>> to, Function<S, DataResult<T>> from) { return null; }
    ...
    default <S> Codec<S> dispatch(String name, Function<T, ?> fn, Function<?, Codec<? extends T>> codec) { return null; }
    default <S> Codec<S> dispatchStable(Function<T, Codec<? extends T>> codec) { return null; }
    default <S> Codec<S> partialDispatch(String name, Function<T, ?> fn, Function<?, Codec<? extends T>> codec) { return null; }
    ...
    default <S> Codec<S> dispatched(Function<T, Codec<? extends T>> function) { return null; }
    default <S> Codec<S> dispatchedMap(Codec<S> codec, Function<T, S> fn) { return null; }
    ...
    default <S> Codec<S> dispatchByName(Function<String, Codec<? extends S>> byName, Function<T, String> name) { return null; }
